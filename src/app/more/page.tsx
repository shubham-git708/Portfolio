      ...
      <div className="w-full max-w-7xl mx-auto px-4 relative z-10">
        ...
        <div className="flex flex-col gap-3 w-full relative z-10">
          <div className="relative z-10">
            <div className="font-bold text-xs text-primary mb-1">Experience</div>
            ...
            <div className="font-bold text-xs text-primary mb-1">Internships</div>
            ...
            <div className="font-bold text-xs text-primary mb-1">Courses Completed</div>
            ...
            <div className="font-bold text-xs text-primary mb-1">Achievements</div>
            <ul className="list-disc ml-6 mt-1 text-base text-gray-700">
              {portfolioConfig.achievements.map((ach, idx) => <li key={idx} dangerouslySetInnerHTML={{__html: ach}} />)}
            </ul>
            <div className="font-bold text-xs text-primary mb-1">Co-curricular</div>
